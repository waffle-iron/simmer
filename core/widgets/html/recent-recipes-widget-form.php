...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_attr_e( 'Title:', Simmer()->domain ); ?></label>
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_attr_e( 'Number of recipes to show:', Simmer()->domain ); ?></label>
...
<p>
	...
	<label for="<?php echo esc_attr( $this->get_field_id( 'show_dates' ) ); ?>"><?php esc_attr_e( 'Display relative dates', Simmer()->domain ); ?></label>
</p>
